...
function App() {
  ...
  const options = {
    ...
    headers: {
      ...
      'X-RapidAPI-Key': '0092dc1019msh42463a07c7609d2p13586djsn855219e3996c',
  ...
  return (
    <div className="bg-gray-50">
      ...
      <main className="p-4 md:p-10 mx-auto max-w-7xl">
        <h1 className="text-3xl font-bold text-gray-800">Daily Tips ({currentDate})</h1>
        <p className="text-sm text-gray-800 mt-4">We provide 75% hit rate daily soccer and basketball betting predictions.<br/>Our predictions are generated by AI powered analysis of previous matches and other factors key to the game’s result.</p>
        <h2 className="text-2xl font-bold text-gray-800 mt-12">Predictions</h2>
        {data ? (
        ...
        {coupons ? (
          <>
          <h2 className="text-xl font-bold text-gray-800 mt-8">Coupons</h2>
